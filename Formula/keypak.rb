class Keypak < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Arashk-A/homebrew-keypak/releases/download/v0.1.0/keypak-arm64.tar.gz"
      sha256 "25d48e06c515ce2ec1b34036778de6cf1e7c537ae0ad6adc621c529bc66e13a4" # arm64
    end
    on_intel do
      url "https://github.com/Arashk-A/homebrew-keypak/releases/download/v0.1.0/keypak-x86_64.tar.gz"
